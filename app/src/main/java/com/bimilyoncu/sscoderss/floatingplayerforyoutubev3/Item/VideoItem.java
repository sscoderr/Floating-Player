...
public class VideoItem {
    ...
    private String publishedAtNotModified;
    private String durationNotModified;
    private String viewCountNotModified;
    ...
    public void setViewCount(String viewCount, byte selection) {
        viewCountNotModified=viewCount;
    ...
    public void setPublishedAt(String publishedAt) {
        if (publishedAt.equals(""))return;
        publishedAtNotModified=publishedAt;
        Date date = new Date();
    ...
    public String getPublishedAtNotModified() {
        return publishedAtNotModified;
    }

    public String getDurationNotModified() {
        return durationNotModified;
    }
    public String getViewCountNotModified() {
        return viewCountNotModified;
    }



    public void setDurationForNewApi(String duration) {

        this.duration = duration;
    }
    public void setViewsForNewApi(String viewCount) {

        this.viewCount = viewCount.substring(0,viewCount.indexOf(" "))+" "+MSettings.activeActivity.getResources().getString(R.string.videoView);
    }
