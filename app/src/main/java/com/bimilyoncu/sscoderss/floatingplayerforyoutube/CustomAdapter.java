...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View rowView, ViewGroup parent) {
        ...
        else { Picasso.with(activity).load(searchResults.get(position).getThumbnailURL()).into(holder.image);}
        ...
        /*if(MSettings.isPlayedVideo)
            if (position==MSettings.playedVideoPos) {
                holder.playedVideoRel.setVisibility(View.VISIBLE);
                holder.playedVideoImage.setVisibility(View.VISIBLE);
            }*/
        return rowView;
    }
                ...
                switch (item.getItemId()) {
                    case R.id.addFavorite:
                        try {
                            ...
                            else Toast.makeText(activity, "Lutfen Kanal Veya Playlist Secmeyin", Toast.LENGTH_SHORT).show();
                        }catch(Exception e){
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.delete:
                        ...
                        break;
                    case R.id.share: Toast.makeText(activity, "share", Toast.LENGTH_SHORT).show();
                        break;
                }
                return true;
            }
